    ...
    public static func compact_outcome_switch_svg(
        ...
        HTML.el(
            ...
            [
                ...
                "preserveAspectRatio": "xMidYMid meet",
                "role": "img",
                "aria-label": "Prikkel leidt tot keuze. De keuze schakelt naar voordeel of nadeel. De actieve uitkomst versterkt of verzwakt de prikkel-keuze-koppeling."
            ]
        ) {
            HTML.el("defs") {
                HTML.el(
            ...
            HTML.el(
                "rect",
                [
                    "class": ClassName.compactRelationFrame,
                    "x": "18",
                    "y": "106",
                    "width": "354",
                    "height": "82",
            ...
            HTML.el(
                "text",
                [
                    "class": ClassName.compactRelationLabel,
                    "x": "195",
                    "y": "101",
                    "text-anchor": "middle"
                ]
